package br.com.joao.consultamedica.service;
...
import br.com.joao.consultamedica.consulta.service.ConsultaService;
...
class ConsultaServiceTest {
    ...
    void cadastrarConsulta(){
        ...
        consulta.setProfissional("Alessandro");
    ...
    void listarConsultas(){
        ...
        assertAll(
                ...
                () -> assertEquals("Dr.Eneas", resultado.get(0).getProfissional()),
                () -> assertEquals("Dr.Livesey", resultado.get(1).getProfissional())
        );
    }
    ...
    void buscarConsulta(){
        Consulta consulta = new Consulta();
        consulta.setProfissional("Dr.Paulo");
